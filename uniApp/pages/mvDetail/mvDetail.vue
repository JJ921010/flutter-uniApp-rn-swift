	...
	<view v-if="!mvDetail== ''">
		...
		<view class="page-panel">
			<view class="videoInfo">
				...
				<view class="tips"
					><text>发布 : {{ mvDetail.publishTime }}</text
					><text class="artistName">演唱 : {{ mvDetail.artistName }}</text></view
				>
				<view class="desc">{{ mvDetail.desc }}</view>
			</view>
			<view class="page-index-title">
				<text class="page-index-title-text">类</text>似MV
			</view>
			<view class="simiMvList">
				<view
					...
					:key="item.id"
					@tap="toMvDetail(item.id)"
				>
					<view class="pic"> <image :src="item.cover" mode="aspectFill"></image> </view>
					<view class="info">
